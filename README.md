...
- [x] Estatísticas de retenção por tema — taxa de acerto, sequência de dias e gráfico de revisões dos últimos 7 dias
...
:feature:stats          — módulo dinâmico das estatísticas de retenção por tema
```
